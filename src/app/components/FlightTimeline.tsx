...
export function FlightTimeline() {
  return (
    <section className="py-20 md:py-32 bg-gradient-to-b from-[#111827] to-[#0B0F19] relative overflow-hidden">
              ...
              >
                ...
                <div className="pt-12 flex flex-col items-center text-center">
                  <motion.div
                    ...
                    className="w-16 h-16 bg-gradient-to-br from-[#D4AF37] to-[#F7C948] rounded-xl flex items-center justify-center mb-4"
                  >
