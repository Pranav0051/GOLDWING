    ...
    return (
        <button
            ...
            className={cn(
                ...
                checked ? "bg-amber-500 border-transparent" : "bg-zinc-200 dark:bg-zinc-800 border-zinc-300 dark:border-zinc-700",
        ...
        >
            <motion.span
                ...
                className={cn(
                    "pointer-events-none flex items-center justify-center rounded-full shadow-sm border",
                    checked ? "bg-[#111827] border-white/20" : "bg-white border-gray-200",
                    sizeConfig.thumb
                )}
                initial={false}
                style={{
