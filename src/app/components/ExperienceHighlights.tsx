...
export function ExperienceHighlights() {
  ...
  return (
    <section
      id="experiences"
      ref={sectionRef}
      className="py-20 md:py-32 bg-gradient-to-b from-[#0B0F19] to-[#111827] relative overflow-hidden"
    >
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-6xl mx-auto">
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="group relative bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 md:p-8 hover:border-[#D4AF37]/50 transition-all duration-300"
            >
              {/* Glow Effect */}
